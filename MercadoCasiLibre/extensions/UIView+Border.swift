...
/// UIVIew extension that add borders as a sublayer to it.
///
/// ```
///     myView.addBorder(side: .bottom, thickness: 1.0, color: .lightGray)
/// ```
...
public extension UIView {
    ...
    func createBorder(side: Side, thickness: CGFloat, color: UIColor, leftOffset: CGFloat = 0, rightOffset: CGFloat = 0, topOffset: CGFloat = 0, bottomOffset: CGFloat = 0) -> CALayer {
    ...
    func createViewBackedBorder(side: Side, thickness: CGFloat, color: UIColor, leftOffset: CGFloat = 0, rightOffset: CGFloat = 0, topOffset: CGFloat = 0, bottomOffset: CGFloat = 0) -> UIView {
    ...
    func addViewBackedBorder(side: Side, thickness: CGFloat, color: UIColor, leftOffset: CGFloat = 0, rightOffset: CGFloat = 0, topOffset: CGFloat = 0, bottomOffset: CGFloat = 0) {
